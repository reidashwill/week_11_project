...
50.times do |product|
  ...
  10.times do |review|
    Review.create!(author: Faker::Name.first_name, content_body: Faker::Lorem.sentence(word_count: 3), rating: Faker::Number.between(from: 1, to: 5), product_id: product.id )
  end
end
